<?php /* footer.php */ ?>
	...
	<footer class="footer">
		<span class="motto-text">
			&ldquo;We Let The Sun Shine In.&rdquo;<br>
			Radiant Window Cleaning
		</span>
		<nav class="footer-nav">
			<a href="/" class="footer-nav-options" title="Home">Home</a> :: 
			<a href="/contact" class="footer-nav-options" title="Contact Us">Contact Us</a> :: 
			<a href="/about" class="footer-nav-options" title="About RWC">About RWC</a> :: 
